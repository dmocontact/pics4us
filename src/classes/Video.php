...
class Video implements HTMLObject
{
  ...
  //       echo '</video>';
        ...
        echo "<script src=\"http://vjs.zencdn.net/4.3/video.js\"></script>";
        echo "<style type=\"text/css\">";
        echo ".vjs-default-skin .vjs-control-bar { font-size: 82% }";
        echo "</style>\”";
        echo "test";

        echo "<video id=\"my_video_1\" class=\"video-js vjs-default-skin\" controls";
        echo "preload=\"auto\" width=\"640\" height=\"264\" poster=\"my_video_poster.png\"";
        echo "data-setup=\"{}\">";
        echo "<source src=\"?t=Vid&f='.$this->fileweb\" type='video/mp4'>";
        ...
        echo "<div id=\"player_7617\" style=\"display:inline-block;\">";
        echo "<a href=\"http://get.adobe.com/flashplayer/\">You need to install the Flash plugin</a> - <a href=\"http://www.supportduweb.com/\">http://www.supportduweb.com/</a>";
        echo "</div>";
        echo "<script type=\"text/javascript\">";
        echo "var flashvars_7617 = {};";
        echo "var params_7617 = {";
        echo "quality: \"high\",";
        echo "wmode: \"transparent\",";
        echo "bgcolor: \"#ffffff\",";
        echo "allowScriptAccess: \"always\",";
        echo "allowFullScreen: \"true\",";
        echo "flashvars: \"fichier=?t=Vid&f=$this->fileweb\"";
        echo "};";
        echo "var attributes_7617 = {};";
        echo "flashObject(\"http://flash.supportduweb.com/flv_player/v1_26.swf\", \"player_7617\", \"720\", \"405\", \"8\", false, flashvars_7617, params_7617, attributes_7617);";
        echo "</script>";
